...
### Phase 0: Foundations
1. Invoke the brainstorming skill to walk through SPEC.md once more and surface any missing assumptions. (At project bootstrap on 2026-05-09 this step resolved the original four open questions in the technical design's section 13: hosting domain, VPS provider, demo symbol set, audit log behavior. Those decisions are now recorded in that section as resolved. A re-run of Phase 0 in a fresh fork or future iteration should focus on whatever assumptions are open at that time.)
